...
Makefile.coq.conf: 
	/snap/coq-prover/31/coq-platform/bin/coq_makefile COQBIN = /snap/coq-prover/31/coq-platform/bin/ src/CpdtTactics.v src/MoreSpecif.v src/DepList.v src/Intro.v src/StackMachine.v src/InductiveTypes.v src/Predicates.v src/Coinductive.v src/Subset.v src/GeneralRec.v src/MoreDep.v src/DataStruct.v src/Equality.v src/Generic.v src/Universes.v src/LogicProg.v src/Match.v src/Reflection.v src/Large.v src/ProgLang.v src/Conclusion.v COQC = 'coqc -R src Cpdt' COQDEP = 'coqdep -R src Cpdt' -o Makefile.coq
